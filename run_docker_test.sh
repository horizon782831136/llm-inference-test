...
#!/bin/bash
# 修改docker name
readonly CONTAINER_NAME="lw_qa_infer_4.0"
# 通过以下链接下载该镜像
# https://klx-sdk-release-public.su.bcebos.com/DS_PD/docker/infer_qa_v4.0.tar.gz
readonly DOCKER_IMAGE="iregistry.baidu-int.com/xpu/infer_qa:v4.0"
